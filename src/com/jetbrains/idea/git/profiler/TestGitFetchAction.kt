...
class TestGitFetchAction : AnAction() {
  ...
  override fun actionPerformed(event: AnActionEvent) {
    ...
    val an = Messages.showOkCancelDialog(msg, "Git Fetch Duration", "Start", "Cancel", Messages.getQuestionIcon())
  ...
  private fun calculate(results: MultiMap<VirtualFile, Long>): String {
    ...
    return "Fetch was called $RUNS times in ${results.size()} roots\n" +
